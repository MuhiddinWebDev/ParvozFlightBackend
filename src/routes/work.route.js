...
router.get('/all-product',  awaitHandlerFactory(workController.getAllProduct));
...
router.patch('/id/:id', auth(Role.Admin), joiMiddleware(workSchemas.updateProduct), awaitHandlerFactory(workController.updateProduct));
router.post('/category/', auth(Role.Admin), joiMiddleware(workSchemas.createCategory), awaitHandlerFactory(workController.createCategory));
router.patch('/category/id/:id', auth(Role.Admin), joiMiddleware(workSchemas.createCategory), awaitHandlerFactory(workController.updateCategory));
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(workController.delete));
router.delete('/product/id/:id', auth(Role.Admin), awaitHandlerFactory(workController.deleteProduct));
router.post('/image', upload, auth(Role.Admin), awaitHandlerFactory(workController.getUploadImage));
