...
router.get('/id/:id', auth(Role.Admin), awaitHandlerFactory(ticketsController.getById));
...
router.post('/create', auth(Role.Admin), joiMiddleware(ticketsSchemas.createAdmin), awaitHandlerFactory(ticketsController.createAdmin));
...
router.post('/image-admin',  auth(Role.Admin), upload, awaitHandlerFactory(ticketsController.uploadImage));
router.patch('/id/:id', auth(Role.Admin), joiMiddleware(ticketsSchemas.update), awaitHandlerFactory(ticketsController.update));
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(ticketsController.delete));
